...
/**
 * Dobrý deň, vážená komisia, ja som Andrei a toto sú moji kolegovia, Zdenek, Richard a Andrej.
 ...
 * precedenčná syntaktická analýza, parser, generátor kódu. Tieto vsetky moduly vyuzivaju pomocné dátové štruktúry.
...
/**
 * Slack za mne je pice (je to pravda), pokud nekoupis professional edition. (prosim nepis toto do prezentace)
 *
