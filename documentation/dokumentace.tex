...
\begin{document}
    ...
    \addcontentsline{toc}{section}{\protect\numberline{}Diagram konečného automatu špecifikujúceho lexikálny analyzátor}
    \label{sec: automat}
    \begin{figure}[!ht]
        \centering
        \vspace{-1.2cm}
    ...
    \newpage
    \section*{LL -- tabuľka}
    \addcontentsline{toc}{section}{\protect\numberline{}LL -- tabuľka}
    \label{sec: LL-tabulka}
    \begin{table}[htb]
        \begin{adjustwidth}{-0.2cm}{}
            \begin{tabular}{!{\vrule width 2pt}>{\columncolor{LightCyan}}P{2.9cm}!{\vrule width 2pt}P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}|P{2.5mm}!{\vrule width 2pt}}
