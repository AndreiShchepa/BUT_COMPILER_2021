...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item Pri precedencii \texttt{s} sme narazili na dva identifikátory alebo identifikátor a znak "(", redukujeme zvyšok výrazu a vraciame parseru riadenie a výsledný typ.
    \end{enumerate}
