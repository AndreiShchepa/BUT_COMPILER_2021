...
\begin{document}
    ...
    Zpracovanie výrazov končí vo chvíli kedy nasledujú po sebe dva identifikátory,
    doteraz spracovávaný výraz sa zredukuje a jeho výsledný typ sa vráti do parseru pre
    sémantickú kontrolu spolu s riadením kde sa rozhodne či v prípade dvoch
    identifikátoroch po sebe ide o chybu alebo správnu syntax.
