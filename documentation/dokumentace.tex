...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item Pri precedencii \texttt{s} sme narazili na dva identifikátory alebo znak ")" a identifikátor. Následne redukujeme zvyšok výrazu a vraciame parseru riadenie.
    \end{enumerate}
