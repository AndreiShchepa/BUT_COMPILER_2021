...
#ifdef DEBUG_BUILT_IN
    DEBUG_PRINT_INSTR  (1 , FUNCTIONS, EOL EOL DEVIDER NON_VAR , EMPTY_STR);
    DEBUG_PRINT_INSTR  (1 , FUNCTIONS, DEVIDER NON_VAR , EMPTY_STR);
    DEBUG_PRINT_INSTR  (1 , FUNCTIONS, DEVIDER NON_VAR , EMPTY_STR);
    DEBUG_PRINT_INSTR  (2 , FUNCTIONS, DEVIDER_2"BUILT-IN FUNCTIONS" NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(3 , "%s", FUNC_CHECK_IS_NIL);   DEBUG_PRINT_INSTR(21, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(4 , "%s", FUNC_TOINTEGER);      DEBUG_PRINT_INSTR(22, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(5 , "%s", FUNC_READI);          DEBUG_PRINT_INSTR(23, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(6 , "%s", FUNC_READN);          DEBUG_PRINT_INSTR(24, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(7 , "%s", FUNC_READS);          DEBUG_PRINT_INSTR(25, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(8 , "%s", FUNC_WRITE);          DEBUG_PRINT_INSTR(26, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(9 , "%s", FUNC_SUBSTR);         DEBUG_PRINT_INSTR(27, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(10, "%s", FUNC_ORD);           DEBUG_PRINT_INSTR(28, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(11, "%s", FUNC_CHR);           DEBUG_PRINT_INSTR(29, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(12, "%s", FUNC_OP_NIL);        DEBUG_PRINT_INSTR(30, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(13, "%s", FUNC_RETYPING_VAR1); DEBUG_PRINT_INSTR(31, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(14, "%s", FUNC_RETYPING_VAR2); DEBUG_PRINT_INSTR(32, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(15, "%s", FUNC_CHECK_OP);      DEBUG_PRINT_INSTR(33, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(16, "%s", FUNC_CHECK_DIV);     DEBUG_PRINT_INSTR(34, FUNCTIONS, NON_VAR , EMPTY_STR);
    PRINT_FUNC_BUILT_IN(17, "%s", FUNC_CHECK_COMP);
    DEBUG_PRINT_INSTR  (2, FUNCTIONS, DEVIDER_2"END BUILT-IN FUNCTIONS" NON_VAR , EMPTY_STR);
    DEBUG_PRINT_INSTR  (1, FUNCTIONS, DEVIDER NON_VAR , EMPTY_STR);
    DEBUG_PRINT_INSTR  (1, FUNCTIONS, DEVIDER NON_VAR , EMPTY_STR);
    DEBUG_PRINT_INSTR  (1, FUNCTIONS, DEVIDER NON_VAR , EMPTY_STR);
#endif
